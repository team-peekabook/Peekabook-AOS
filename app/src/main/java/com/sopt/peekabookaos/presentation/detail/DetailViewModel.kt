...
class DetailViewModel : ViewModel() {
    ...
    fun initDetailFriendData() {
        _detailData.value = Detail(
            description = "구글에서 완전히 열심히 찾아보면 갤럭시나 아이폰을 사용하면 다이얼로그를 잘 알것이다. 어떤 버튼을 클릭했을 때나 이벤트가 실행되거나 완료되면 어떤 확인문구와 함께 작게 뜨는 창을 본적이 있을 것이다. 그것이 다이얼로그다. 다이얼로그에는 종류가 정말 많은데 코드가 어떻게 구현되는지 알아보도록 하자",
            memo = "",
            book = Book(
                bookImage = "http://image.yes24.com/goods/90365124/XL",
                bookTitle = "아무튼, 여름",
