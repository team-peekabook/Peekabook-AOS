...
class NotificationBookShelfPickAdapter(private val clickListener: ItemClickListener<Picks>) :
    ListAdapter<Picks, NotificationBookShelfPickAdapter.PickViewHolder>(DIFF_CALLBACK) {
